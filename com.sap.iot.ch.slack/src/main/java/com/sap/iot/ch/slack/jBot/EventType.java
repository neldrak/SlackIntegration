...
public enum EventType {
    ...
    FILE_UNSHARED, FILE_PUBLIC, FILE_PRIVATE, FILE_CHANGE, FILE_DELETED, FILE_COMMENT_ADDED, FILE_COMMENT_EDITED,
    FILE_COMMENT_DELETED, PIN_ADDED, PIN_REMOVED, PRESENCE_CHANGE, MANUAL_PRESENCE_CHANGE, PREF_CHANGE, USER_CHANGE,
